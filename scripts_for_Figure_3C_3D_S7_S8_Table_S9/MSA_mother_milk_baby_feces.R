################################################################################
##### Per-genus multiple sequence alignments of ASVs in maternal milk and infant fecal samples
...
######################################################################
# Genus-level MSAs of ASVs in maternal-baby fecal samples
######################################################################

#################################################
#A. 16S V3-V4 - Mother Milk vs Baby Feces 
#################################################
...
metadata_16S <- metadata[grepl("pilot", metadata$description) &
                           ...
                           (metadata$sample_type == "Milk" | (metadata$sample_type == "Faeces" &
                                                                metadata$sample_origin == "Infant")),]
...
#***********************************************************************
MSA_result(matching_ASVs_16S,shared_genera_16S, "~/Desktop/PhD/Projects/Johanne methods paper/Final_paper_version/16S/Mother_Milk-Baby_Feces/", "16S_mother_milk_baby_feces")

#################################################
#B. 16S_23S - Mother Milk vs Baby Feces 
#################################################
...
#***********************************************************************
MSA_result(matching_ASVs_16S23S, shared_genera_16S23S, "~/Desktop/PhD/Projects/Johanne methods paper/Final_paper_version/16S23S/Mother_Milk-Baby_Feces/", "16S23S_mother_milk_baby_feces")
...
# 16S V3-V4 results
write.table(genera_counts_16S,"16S/Mother_Milk-Baby_Feces/Genera_counts.txt", sep = "\t", row.names = T, quote = FALSE) 
saveRDS(genera_in_pairs_16S, "16S/Mother_Milk-Baby_Feces/Genera_counts_pairs.rds")
saveRDS(matching_ASVs_16S, "16S/Mother_Milk-Baby_Feces/ASVs_shared_genera.rds")

# 16S-ITS-23S results
write.table(genera_counts_16S23S,"16S23S/Mother_Milk-Baby_Feces/Genera_counts.txt", sep = "\t", row.names = T, quote = FALSE) 
saveRDS(genera_in_pairs_16S23S, "16S23S/Mother_Milk-Baby_Feces/Genera_counts_pairs.rds")
saveRDS(matching_ASVs_16S23S, "16S23S/Mother_Milk-Baby_Feces/ASVs_shared_genera.rds")
