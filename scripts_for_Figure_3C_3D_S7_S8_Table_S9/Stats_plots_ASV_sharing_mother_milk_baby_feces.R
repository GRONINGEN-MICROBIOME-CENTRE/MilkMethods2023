################################################################################
##### ASVs transmission between maternal milk and infant fecal samples:  statistical analysis and plotting
...
# Read results files
final_PSE_data <- read.delim("Result_tables/PSE_table_maternal_milk_infant_oral.txt", header = T, check.names = F) 
...
pdf('Plots/PSE_relatedness_V3V4_mother_milk_baby_feces.pdf', width=5.6, height=4)
...
pdf('Plots/PSE_relatedness_16S23S_mother_milk_baby_feces.pdf', width=5.6, height=4)
...
# Save results
########################
write.table(final_PSE_data_summary_long, file ="~/Desktop/PhD/Projects/Johanne methods paper/Final_paper_version/Result_tables/Mother_milk_Baby_Feces_final_PSE_results.txt", sep="\t")
write.table(sequencing_PSE_results, file ="~/Desktop/PhD/Projects/Johanne methods paper/Final_paper_version/Result_tables/Mother_milk_Baby_Feces_final_PSE_results_Seq_Technology.txt", sep="\t")
