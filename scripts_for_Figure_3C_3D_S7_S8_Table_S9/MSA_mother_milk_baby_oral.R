...
################################################################################
##### Per-genus multiple sequence alignments of ASVs in maternal milk and infant oral samples
...
######################################################################
# Genus-level MSAs of ASVs in maternal-baby oral samples
######################################################################

#################################################
#A. 16S V3-V4 - Mother Milk vs Baby Oral 
#################################################
...
metadata_16S <- metadata[grepl("pilot", metadata$description) &
                           ...
                           (metadata$sample_type == "Milk" | metadata$sample_type == "Oral_swab"),]
...
names_genera_16S <- unique(names_genera_16S) # 144 unique genera
...
#***********************************************************************
MSA_result(matching_ASVs_16S,shared_genera_16S, "~/Desktop/PhD/Projects/Johanne methods paper/Final_paper_version/16S/Mother_Milk-Baby_Oral/", "16S_mother_milk_baby_oral")

#################################################
#B. 16S_23S - Mother Milk vs Baby Oral 
#################################################
...
names_genera_16S23S <- unique(names_genera_16S23S) #40
...
#***********************************************************************
MSA_result(matching_ASVs_16S23S, shared_genera_16S23S, "~/Desktop/PhD/Projects/Johanne methods paper/Final_paper_version/16S23S/Mother_Milk-Baby_Oral/", "16S23S_mother_milk_baby_oral")
...
# 16S V3-V4 results
write.table(genera_counts_16S,"16S/Mother_Milk-Baby_Oral/Genera_counts.txt", sep = "\t", row.names = T, quote = FALSE) 
saveRDS(genera_in_pairs_16S, "16S/Mother_Milk-Baby_Oral/Genera_counts_pairs.rds")
saveRDS(matching_ASVs_16S, "16S/Mother_Milk-Baby_Oral/ASVs_shared_genera.rds")

# 16S-ITS-23S results
write.table(genera_counts_16S23S,"16S23S/Mother_Milk-Baby_Oral/Genera_counts.txt", sep = "\t", row.names = T, quote = FALSE) 
saveRDS(genera_in_pairs_16S23S, "16S23S/Mother_Milk-Baby_Oral/Genera_counts_pairs.rds")
saveRDS(matching_ASVs_16S23S, "16S23S/Mother_Milk-Baby_Oral/ASVs_shared_genera.rds")
